...
Always provide a seamless, conversational experience and explain what you're doing.""",
    ...
    def search_remote_servers(self, search_query: str) -> list:
        ...
        try:
            self._status("Discovering workflows")
    ...
    def establish_connection(self, server_name: str) -> dict:
        ...
        try:
            ...
            payload = {"action": "handshake", "workflow_name": server_name}
            ...
            self._log("[MODE] Switched to SERVER mode", "info")
    ...
    def get_user_mode_tools(self) -> list:
        ...
        if self.in_context_servers:
            ...
            for server in self.in_context_servers:
                ...
                if name:
                    server_options.append({"const": name, "description": desc})
...
After connecting, you'll have access to the server's tools to help the user accomplish their goal.""",
                    "parameters": {
                        "type": "object",
                        "properties": {"server_name": {"oneOf": server_options}},
    ...
    def disconnect_server(self) -> dict:
        ...
        try:
            ...
            self._log("[MODE] Switched to USER mode", "info")
            print(
                f"  \033[38;5;147m◇\033[0m  \033[38;5;245mDisconnected from\033[0m \033[38;5;183m{workflow_name}\033[0m"
            )
...
- You want to disconnect or switch servers""",
    ...
    def run(self):
        ...
        print(
            "\033[38;5;147m│\033[0m                    \033[1;38;5;189mC O N C I E R G E\033[0m                   \033[38;5;147m│\033[0m"
        )
        print("\033[38;5;147m│\033[0m                                                        \033[38;5;147m│\033[0m")
        print(
            "\033[38;5;147m│\033[0m                \033[38;5;110mAgentic Web Interfaces\033[0m                  \033[38;5;147m│\033[0m"
        )
        print("\033[38;5;147m│\033[0m                                                        \033[38;5;147m│\033[0m")
        print("\033[38;5;147m╰────────────────────────────────────────────────────────╯\033[0m")
        print()
        ...
        print("\033[38;5;245m  Type \033[3;38;5;183mexit\033[0m \033[38;5;245mto quit\033[0m")
        print()
        ...
        while True:
            try:
                ...
                if user_input.lower() == "exit":
                    ...
                    print("\033[38;5;147m╭────────────────────────────────────────────────────────╮\033[0m")
                    print(
                        "\033[38;5;147m│\033[0m            \033[38;5;183mThank you for using Concierge\033[0m               \033[38;5;147m│\033[0m"
                    )
                    print("\033[38;5;147m╰────────────────────────────────────────────────────────╯\033[0m")
                    print()
                    break
