...
from concierge.core import State, StateTransfer, construct, stage, task, workflow
...
class ShoppingWorkflow:
    ...
    transitions = {CartStage: [CheckoutStage, ReviewStage], CheckoutStage: [ReviewStage], ReviewStage: [CartStage]}
